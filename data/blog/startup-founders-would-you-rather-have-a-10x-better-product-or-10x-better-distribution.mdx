...
6.14.4
 ...
 [youtubelink](https://youtu.be/Xgui4TDNc)

 [linux](https://www.geeksforgeeks.org/getting-started-with-vim-editor-in-linux/)

  Install neo vim using <> sudo apt-get install neovim</>
 change the File path to home  < > cd -- </>
 ...
 You need a plugin Manager to Install plugins on neovim/vim
 here we are going to use  vim-plug

 [vimgithub](https://github.com/junegunn/vim-plug)
